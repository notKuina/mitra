    ...
    <div class="container" style="margin-top:20px;margin-bottom:20px;padding:50px;background-color:#ddd; color:orange;">
        <div class="row">
            <div class="col-md-3">
        ...
        <script>
            ...
            $.ajax({
                ...
                success:function(response){
                  ...
                  posts_html='<div class="col-md-4 equal-heigth"><img style="min-height:50px; background-color:#fff; width:96% src="'+url+'">
                  <div class="row-like-comment"><div class="col-md-6 ">'+nFormatter(likes)+' LIKES</div><div class="col-md-6 ">
                  '+nFormatter(comments)+' COMMENTS</div></div></div>';
